<?
	...
	class Db_SqlBase extends Db_WhereBase 
	{
		 ...
		 * </pre>
		 * @documentable
		 * @param string $table_name Specifies the table name to join.
		 * @param string $conditions Specifies the JOIN conditions (ON statement).
		 * @param string $columns Specifies a list of columns to include to the result set. 
		 * This parameter is ignored in ActiveRecord.
		 * @param string $type Specifies the join type - <em>left</em>, <em>inner</em>, <em>left outer</em>, <em>full outer</em>.
		...
		/**
		 * Allows to order the result of the {@link Db_ActiveRecord::find_all() find_all()} method by a specific table column.
		 ...
		 * @documentable
		 * @param string $spec Specifies the SQL order clause.
