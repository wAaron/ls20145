<?php
	...
	class Db_FormFieldDefinition extends Db_FormElement
	{
		 ...
		 * @deprecated Use {@link Db_FormFieldDefinition::htmlFullWidth() htmlFullWidth()} method instead.
		 * @documentable
		...
		{
			return $this->htmlFullWidth($value);
		}
		 ...
		 * @return Db_FormFieldDefinition Returns the updated form field definition object.
		 */
		public function htmlFullWidth($value)
		{
			$this->htmlFullWidth = $value;
			return $this;
		}
		 ...
		 * </pre>
		 * @documentable
		 * @param mixed $placeholder Specifies the placeholder (can be string or boolean, set to false to hide default date/datetime placeholders).
		 * @param string $field_section Specifies the field section the placeholder is for (used values: 'time' for time section of a datetime field).
		 * @return Db_FormFieldDefinition Returns the updated form field definition object.
		 */
		 ...
		 * @param string $field_section Optional, used for multi-field form fields (datetime).
		 * @return mixed Returns the placeholder assigned to the form field or form field section.
		 */
		public function getPlaceholder($field_section = null)
		{
