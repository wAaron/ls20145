...
;(function ($, window, undefined) {
  ...
  var defaults = {
    ...
    methods = {
      ...
      init : function (opts) {
        return this.each(function () {
          ...
          if ($.isEmptyObject(settings)) {
            ...
            settings.$document.delegate('.joyride-next-tip, .joyride-modal-bg', 'click.joyride', function (e) {
              e.preventDefault();
            ...
            settings.$document.delegate('.joyride-close-tip', 'click.joyride', function (e) {
              e.preventDefault();
              methods.end();
            });
      ...
      destroy : function () {
        if(!$.isEmptyObject(settings)){
        settings.$document.undelegate('.joyride');
        }

        $(window).undelegate('.joyride');
        $('.joyride-close-tip, .joyride-next-tip, .joyride-modal-bg').undelegate('.joyride');
      ...
      pos_default : function (init) {
        ...
        if (!/body/i.test(settings.$target.selector)) {
            ...
            if (methods.bottom()) {
              ...
              settings.$next_tip.css({
                top: settings.$target.offset().top - 25,
