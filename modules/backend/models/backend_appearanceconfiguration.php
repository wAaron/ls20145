<?
	...
	class Backend_AppearanceConfiguration extends Core_Configuration_Model
	{
		...
		{
			$this->add_field('menu_style', 'Main menu style', 'full', db_varchar)->renderAs(frm_dropdown)->tab('Main menu')->comment('Note that on mobile devices the menu is always cascading', 'above');
		}
