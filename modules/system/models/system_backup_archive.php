	...
	class System_Backup_Archive extends Db_ActiveRecord 
	{
		...
		public static function backup($throwOnError = false, $force = false)
		{
			try
			{
				...
				Backend::$events->fireEvent('core:onAfterArchiveCreate');
			}
			catch (Exception $ex) 
			{
				if ($throwOnError)
		...
		/**
		 * Triggered before LemonStand {@link http://lemonstand.com/docs/configuring_and_using_the_backup_system archive} is created.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
		 *   Backend::$events->addEvent('core:onBeforeArchiveCreate', $this, 'before_archive_create');
		 * }
		 *  
		 * public function before_archive_create()
		 * {
		 *   // Do something
		 * }
		 * </pre>
		 * @event core:onBeforeArchiveCreate
		 * @see http://lemonstand.com/docs/configuring_and_using_the_backup_system Configuring and using the backup system
		 * @see core:onBeforeArchiveRestore
		 * @see core:onAfterArchiveCreate
		 * @package core.events
		 * @author LemonStand eCommerce Inc.
		 */
		private function event_onBeforeArchiveCreate() {}
			
		/**
		 * Triggered after LemonStand {@link http://lemonstand.com/docs/configuring_and_using_the_backup_system archive} is created.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
		 ...
		 * }
		 * </pre>
		 * @event core:onAfterArchiveCreate
		 * @see http://lemonstand.com/docs/configuring_and_using_the_backup_system Configuring and using the backup system
		 * @see core:onBeforeArchiveRestore
		 * @see core:onBeforeArchiveCreate
		 * @package core.events
		 * @author LemonStand eCommerce Inc.
		 */
		private function event_onAfterArchiveCreate() {}
			
		/**
		 * Triggered before LemonStand {@link http://lemonstand.com/docs/configuring_and_using_the_backup_system archive} is restored.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
		 ...
		 * }
		 * </pre>
		 * @event core:onBeforeArchiveRestore
		 * @see http://lemonstand.com/docs/configuring_and_using_the_backup_system Configuring and using the backup system
		 * @see core:onBeforeArchiveCreate
		 * @see core:onAfterArchiveCreate
		 * @package core.events
		 * @author LemonStand eCommerce Inc.
		 */
		private function event_onBeforeArchiveRestore() {}
	}
?>