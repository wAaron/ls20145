		...
		public function update_price_index()
		{
			...
			if ($cnt = count($index_values))
			{
				...
				foreach ($index_values as $index=>$values)
				{
					$query .= '('.
						$this->id.','.
						mysql_real_escape_string($values['group_id']).','.
						mysql_real_escape_string($values['price']).','.
						mysql_real_escape_string($values['min_price']).','.
						mysql_real_escape_string($values['max_price']).','.
