...
//				$this->add_form_custom_area('tax_summary')->tab('Order Details')->noForm();
		...
		{
			if (Db_DbHelper::scalar('select count(*) from shop_orders') >= 10)
  throw new Phpr_ApplicationException('The maximum number of orders (10) is exceeded. Please consider ordering a commercial license.');
