<? 
	...
	class Shop_ProductExport
	{
		...
		public static function export_csv($iwork = false, $columns_override = null, $write_to_file = false)
		{
			set_time_limit(3600);
			...
			try
			{
				...
				$om_records_query = 'select * from shop_option_matrix_records where product_id=:product_id order by id';
