<?php
	...
	class Blog_Module extends Core_ModuleBase
	{
		...
		{
			$host_obj->add_field($this, 'notify_blog_comments', 'Notify user about new blog comments')->renderAs(frm_checkbox)->comment('Check this checkbox if you want this user to be notified about new blog post comments.', 'above')->cssClasses('notification');
		...
		{
			return array('blog_variables'=>'Blog variables');
		}
