<?
	...
	class Blog_Configuration extends Core_Configuration_Model
	{
		...
		protected function build_form()
		{
			...
			$this->add_field('comment_notifications_rule', 'New comment notifications', 'full', db_number)->tab('Notifications')->renderAs(frm_radio)->comment('Please choose which users should receive notifications about new blog comments. Please note that notifications are only sent to users who have the "Notify user about new blog comments" option checked in the System/Users/Edit User form.', 'above');
		}
